...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1144&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-fontliberation-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-fontliberation` can be installed with `conda`:
...
```
mamba install r-fontliberation
```

It is possible to list all of the versions of `r-fontliberation` available on your platform with `conda`:
...
```
mamba search r-fontliberation --channel conda-forge
```
...
mamba repoquery search r-fontliberation --channel conda-forge

# List packages depending on `r-fontliberation`:
mamba repoquery whoneeds r-fontliberation --channel conda-forge

# List dependencies of `r-fontliberation`:
mamba repoquery depends r-fontliberation --channel conda-forge
```
